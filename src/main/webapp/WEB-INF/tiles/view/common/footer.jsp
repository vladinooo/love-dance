                ...
                <div class="row">
                    <div class="col-md-8">
                        <div id="project-details-carousel" class="owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <img src="/static/spectrum/assets/img/demo-portfolio/10.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="/static/spectrum/assets/img/demo-portfolio/11.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="/static/spectrum/assets/img/demo-portfolio/12.jpg" alt="">
                            </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <ul class="list-unstyled project-details">
                            ...
                            <li>
                                <strong>Date:</strong>January 2014</li>
                        </ul>
                    </div>
                </div>
            </div>
